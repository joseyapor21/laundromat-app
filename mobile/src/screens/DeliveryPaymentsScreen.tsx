    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {loading ? (
        ...
        >
          ...
          <View style={styles.summaryBanner}>
            ...
            <Text style={styles.summaryText}>
              ...
              <Text style={{ fontWeight: '800' }}>
                ${orders.reduce((sum, o) => sum + (o.totalAmount || 0), 0).toFixed(2)} total
              </Text>
            </Text>
          </View>
          ...
          {orders.map(order => {
            const method = selectedMethod[order._id] || 'cash';
            const isPaying = markingPaid === order._id;
            return (
              <View key={order._id} style={styles.card}>
                ...
                {/* Mark Paid button */}
                <TouchableOpacity
                  style={[styles.paidBtn, isPaying && styles.paidBtnDisabled]}
                ...
                >
                  {isPaying ? (
                    ...
                    <>
                      ...
                      <Text style={styles.paidBtnText}>Mark as Paid · ${(order.totalAmount || 0).toFixed(2)}</Text>
                    </>
                  )}
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  deliveryBadgeText: { fontSize: 11, fontWeight: '600', color: '#7c3aed' },
